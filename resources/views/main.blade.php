...
<div class="container" id="room">
	...
	<div class="row">
  	...
  	<div class="col-sm-6 col-md-4">
	    <div class="thumbnail hovereffect">
	      ...
	      <div class="caption">
	      	...
	      	<div class="overlay">
           <h2>Cabañas</h2>
           <a class="info" href="cabaña1" target="_Blank">LEER MÁS</a>
        </div>
	 ...
	 <div class="col-sm-6 col-md-4">
        ...
        <div class="overlay">
           <h2>Cabañas</h2>
           <a class="info" href="cabaña2" target="_Blank">LEER MÁS</a>
        </div>
	 ...
	 <div class="col-sm-6 col-md-4">
        ...
        <div class="overlay">
           <h2>Cabañas</h2>
           <a class="info" href="cabaña3" target="_Blank">LEER MÁS</a>
        </div>
